	...
	<view class="login-box">
		...
		<view class="uni-container">
			<uni-forms ref="form" v-model="formData" :rules="rules">
				<uni-forms-item left-icon="person-filled" name="username" label="用户名">
				...
				<uni-forms-item left-icon="locked-filled" class="icon-container" name="password" label="密码">
				...
				rules: {
					...
					username: {
						rules: [{
							...
							{
								minLength: 2,
								errorMessage: '用户名至少{minLength}个字符',
								// maxLength: 30,
...
<style>
	...
	/* 在vue页面里uni框架生成元素的class不加::v-deep不生效 */

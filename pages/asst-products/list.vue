		  ...
		  <unicloud-db ref="udb" :collection="collectionList" :where="where" page-data="replace"
			...
			<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
			  <uni-tr>
				...
				<uni-th align="center" sortable @sort-change="sortChange($event, 'enable')">产品状态</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/asst-products.js';
  ...
  export default {
    data() {
      return {
        collectionList: [ db.collection('asst-products').field('name,enable,comment,files,create_date,creator_id,member_ids').getTemp(),db.collection('uni-id-users').field('_id, username as text').getTemp() ],
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
